...
generate_config () {
  ...
  PUBL_DRS_ALLOWLISTED_ORG_IDS_S=$(echo -n '"'; echo -n ${PUBL_DRS_ALLOWLISTED_ORG_IDS_A[@]} | sed s/' '/'","'/g; echo -n '"';)
  SUBSCR_DRS_ALLOWLISTED_ORG_IDS_S=$(echo -n '"'; echo -n ${SUBSCR_DRS_ALLOWLISTED_ORG_IDS_A[@]} | sed s/' '/'","'/g; echo -n '"';)
  ...
  s/{{PUBL_PROJECT_ID_BQ_FED_DS}}/$PUBL_PROJECT_ID_BQ_FED_DS/;
  ...
  s/{{PUBL_ENABLE_POLICY_TAGS}}/$PUBL_ENABLE_POLICY_TAGS/;
  s/{{PUBL_ALLOWLISTED_VPCSC_OPT}}/$PUBL_ALLOWLISTED_VPCSC_OPT/;
  ...
  s!{{PUBL_DRS_ALLOWLISTED_ORG_IDS_S}}!$PUBL_DRS_ALLOWLISTED_ORG_IDS_S!;
  ...
  s!{{SUBSCR_DRS_ALLOWLISTED_ORG_IDS_S}}!$SUBSCR_DRS_ALLOWLISTED_ORG_IDS_S!;
