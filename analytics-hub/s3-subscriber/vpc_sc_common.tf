...
module "access_context_manager_policy" {
  ...
  parent_id   = var.vpc_sc_subscriber_project_org_id
  policy_name = var.vpc_sc_subscriber_global_access_policy_name
}
...
module "access_level_allow_corp" {
  ...
  ip_subnetworks = var.vpc_sc_subscriber_access_level_corp_ip_subnetworks
