...
echo "Checking seed projects ${PROV_ORG_ID}/${PROV_PROJECT_ID_SEED} ${CUST_ORG_ID}/${CUST_PROJECT_ID_SEED} ... "
...
echo -n "Checking terraform state bucket $CUST_STATE_BUCKET_URL ... "
gcloud_check_and_create_state_bucket $CUST_STATE_BUCKET_URL $CUST_PROJECT_ID_SEED $REGION
